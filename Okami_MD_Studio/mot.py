...
class ExportMOT(Operator, ExportHelper):
	...
	precision_only: BoolProperty(name = "Precision only", description = "If this setting is activated, the whole file will be exported with full precision, ideal for cutscenes.", default = True,)
